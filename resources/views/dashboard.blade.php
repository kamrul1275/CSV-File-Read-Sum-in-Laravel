...
@endif
            ...
            <form action="{{ route('employe.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Employee_Id" id="exampleInputEmail1" aria-describedby="emailHelp">
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="Phone_Number" id="exampleInputEmail1" aria-describedby="emailHelp">
                  </div>
     
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">JoB Id</label>
                    <input type="text" class="form-control" name="Job_Id" id="exampleInputEmail1" aria-describedby="emailHelp">
                  </div>
